...
<head>
    ...
    body
    {
        background-image:url("https://previews.123rf.com/images/rasslava/rasslava1408/rasslava140800046/31169073-falling-numbers-isolated-on-white-background-education-concept.jpg");
...
<form>
    ...
    <label> Previously added questions </label>
	<table id="questions" >
	  <tr>
	    <th>Questions</th>
	    <th>Action</th>
